...
public class GraphLoader_fw {

    public static Graph_fw loadGraph(String hospitalFilePath, String graphFilePath) throws IOException {
        Graph_fw graph = new Graph_fw();
